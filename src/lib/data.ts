...
export const mockProjects: Project[] = [
  {
    ...
    tasks: [
      { id: 't1-1', title: 'Foundation Pouring', type: 'Task', owner: 'user-engineer-1', status: 'Completed', dueDate: '2023-08-15', createdAt: '2023-07-01T10:00:00Z' },
      { id: 't1-2', title: 'Structural Steel Erection (Floors 1-25)', type: 'Task', owner: 'user-engineer-2', status: 'Completed', dueDate: '2024-02-28', createdAt: '2023-07-01T10:00:00Z' },
      { id: 't1-3', title: 'Curtain Wall Installation', type: 'Milestone', owner: 'user-engineer-1', status: 'In Progress', dueDate: '2024-09-30', createdAt: '2023-07-01T10:00:00Z' },
      { id: 't1-4', title: 'MEP Systems Installation', type: 'Task', owner: 'user-engineer-2', status: 'Not Started', dueDate: '2024-10-31', createdAt: '2023-07-01T10:00:00Z' },
    ],
    documents: [
      { id: 'd1-1', name: 'Architectural_Plans_Rev3.pdf', path: '#', type: 'Blueprint', uploadedAt: '2023-05-20' },
      { id: 'd1-2', name: 'Main_Construction_Contract.pdf', path: '#', type: 'Contract', uploadedAt: '2023-06-01' },
      { id: 'd1-3', name: 'Building_Permit_77A.pdf', path: '#', type: 'Permit', uploadedAt: '2023-07-10' },
    ],
    milestones: [
  ...
  },
  {
    ...
    createdBy: 'user-admin',
    tasks: [
      { id: 't2-1', title: 'Lead Paint Removal', type: 'Task', owner: 'user-engineer-1', status: 'Completed', dueDate: '2024-01-31', createdAt: '2023-11-01T10:00:00Z' },
      { id: 't2-2', title: 'Install new seismic dampers', type: 'Milestone', owner: 'user-engineer-1', status: 'In Progress', dueDate: '2024-11-30', createdAt: '2023-11-01T10:00:00Z' },
      { id: 't2-3', title: 'Repave roadway', type: 'Task', owner: 'user-engineer-1', status: 'Overdue', dueDate: '2024-05-30', createdAt: '2023-11-01T10:00:00Z' },
    ],
    documents: [
      { id: 'd2-1', name: 'Seismic_Analysis_Report.pdf', path: '#', type: 'Report', uploadedAt: '2023-09-01' },
      { id: 'd2-2', name: 'Structural_Blueprints_Update.pdf', path: '#', type: 'Blueprint', uploadedAt: '2023-10-05' },
    ],
    milestones: [
  ...
  },
  {
    ...
    createdBy: 'user-admin',
    tasks: [
        { id: 't3-1', title: 'Landscaping and Irrigation', type: 'Task', owner: 'user-engineer-2', status: 'In Progress', dueDate: '2024-07-31', createdAt: '2022-04-01T10:00:00Z' },
        { id: 't3-2', title: 'Final Home Inspections', type: 'Task', owner: 'user-engineer-2', status: 'In Progress', dueDate: '2024-08-15', createdAt: '2022-04-01T10:00:00Z' },
    ],
    documents: [
      { id: 'd3-1', name: 'Master_Plan.pdf', path: '#', type: 'Blueprint', uploadedAt: '2022-01-15' },
      { id: 'd3-2', name: 'Sales_Contracts_Template.pdf', path: '#', type: 'Contract', uploadedAt: '2022-03-01' },
    ],
    milestones: [
