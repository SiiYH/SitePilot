...
import ImportProjectDialog from './_components/ImportProjectDialog';
                ...
                !company.activated || isLicenseExpired ? (
                  ...
                  <>
                    <ImportProjectDialog
                      ...
                      onProjectsImported={() => {
                        // Refresh logic if needed, but Firestore subscription handles it.
                        // Maybe clear search/filters?
                      }}
                    />
