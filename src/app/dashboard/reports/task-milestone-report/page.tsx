...
export default function TaskMilestoneReportPage() {
  ...
  useEffect(() => {
    ...
    toast({
        title: 'Report Loaded',
        description: 'The task &amp; milestone report has been updated for the selected filters.',
      });
      ...
      <ReportsPageLayout>
        <div className="space-y-6">
          <div className="print-hidden flex flex-col gap-4">
            <div>
                <h2 className="text-2xl font-bold tracking-tight">Task &amp; Milestone Report</h2>
                <p className="text-muted-foreground">
                A detailed list of all tasks and milestones.
                </p>
            </div>
